const ABI_SUBSCRIPTION_SEPOLIA = [
  {
    inputs: [
      {
...
const FACTORY_AMOY_ADDRESS = '0x9Fe6511002323c34012621F1f48479e08FCb425E';
...
export const commonEnvironment = {
  ...
  MARKETPLACE_ADDRESS: MARKETPLACE_AMOY_ADDRESS,
  ABI_FACTORY: ABI_FACTORY_AMOY,
  FACTORY_ADDRESS: FACTORY_AMOY_ADDRESS,
  PINATA_PIN_LIST_URL,
  metadata: {
    name: 'DappHomes',
